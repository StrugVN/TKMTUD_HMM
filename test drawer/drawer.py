...
pg.init()
pg.font.init()
font_bigger = pg.font.SysFont('Helvetica Neue', 50, bold=True)
font_big = pg.font.SysFont('Helvetica Neue', 45)
font = pg.font.SysFont('Helvetica Neue', 33)
            ...
            if event.type == pg.QUIT:
                ...
                if (color == white or color == black or color == slategray) and no_input:
                    ...
                    if scale != 1:
                        ...
                        pg.draw.circle(screen, paint, pg.mouse.get_pos(), 10)
